...
public class SampleSampleTestListViewModel : Core.EntityLists.EntityListViewModel<SampleTest>, IMvvmContextProvider
{
    ...
    public SampleSampleTestListViewModel(IAclService acl, Injector i, Sample sample) : base(i, c => c
        ...
        //            {XamlTool.Namespace<IDocumentViewClass>(out var ns2)}
        //            {XamlTool.Namespace<DefaultViewMode>(out var ns3)}
        //            ViewClass=""{{x:Type {XamlTool.Type<IDocumentViewClass>(ns2)}}}""
        //            ViewMode=""{{x:Type {XamlTool.Type<DefaultViewMode>(ns3)}}}""
        //            Model=""{{Binding Model}}""/>
        //    </GroupBox>"
        //)
