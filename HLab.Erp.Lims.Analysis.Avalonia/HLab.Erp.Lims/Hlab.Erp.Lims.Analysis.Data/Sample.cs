...
{
    public Sample() {
        //    private bool _expired = H.Property<bool>(c =>
        ...
        _endOfLife = this.WhenAnyValue(e => e.ExpirationDate, e => e.Life, selector: (e, l) => GetEndOfLife(e,l)).ToProperty(this, e => e.EndOfLife);
    ...
    private SampleWorkflow.Stage _stage = H.Property<SampleWorkflow.Stage>(c => c
    ...
    private TimeSpan _life = H.Property<TimeSpan>(c => c
    ...
    ObservableAsPropertyHelper<bool> _endOfLife;
